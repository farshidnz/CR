...
namespace CashrewardsOffers.Application.UnitTests.ANZ
{
    public class AnzUpdateServiceTests
    {
        ...
        public async Task UpdateMerchant_ShouldUpdateWithChanges_GivenModelExists()
        {
            ...
            state.AnzItemPersistenceContext.Verify(p => p.Update(It.IsAny<AnzItem>()), Times.Once);
        }
        ...
        public async Task UpdateMerchant_ShouldNotMakeChanges_GivenClientIsNotForCashrewards()
        {
            ...
            state.AnzItemPersistenceContext.Verify(p => p.Update(It.IsAny<AnzItem>()), Times.Never);
        }
        ...
        public async Task UpdateMerchant_ShouldUpdateExistingItemsSequence_GivenNewItem()
        {
            ...
            state.AnzItemPersistenceContext.Verify(p => p.Insert(It.IsAny<AnzItem>()), Times.Once);
            state.AnzItemPersistenceContext.Verify(p => p.Update(It.IsAny<AnzItem>()), Times.Exactly(4));
            state.AnzItemPersistenceContext.Verify(p => p.Update(It.Is<AnzItem>(i => i.ItemId == "100" && i.Merchant.InstoreRanking == 1)), Times.Once);
            state.AnzItemPersistenceContext.Verify(p => p.Update(It.Is<AnzItem>(i => i.ItemId == "101" && i.Merchant.InstoreRanking == 4)), Times.Once);
            state.AnzItemPersistenceContext.Verify(p => p.Update(It.Is<AnzItem>(i => i.ItemId == "102" && i.Merchant.InstoreRanking == 3)), Times.Once);
            state.AnzItemPersistenceContext.Verify(p => p.Update(It.Is<AnzItem>(i => i.ItemId == "103" && i.Merchant.InstoreRanking == 2)), Times.Once);
        }
        ...
        public async Task UpdateMerchant_ShouldUpdateItemsThatNeedResequencing_GivenNewItem()
        {
            ...
            state.AnzItemPersistenceContext.Verify(p => p.Insert(It.IsAny<AnzItem>()), Times.Once);
            state.AnzItemPersistenceContext.Verify(p => p.Update(It.IsAny<AnzItem>()), Times.Exactly(2));
            state.AnzItemPersistenceContext.Verify(p => p.Update(It.Is<AnzItem>(i => i.ItemId == "101" && i.Merchant.InstoreRanking == 4)), Times.Once);
            state.AnzItemPersistenceContext.Verify(p => p.Update(It.Is<AnzItem>(i => i.ItemId == "102" && i.Merchant.InstoreRanking == 3)), Times.Once);
        }
        ...
        public async Task DeleteMerchant_ShouldUpdateItemToDeleted_GivenItemExists()
        {
            ...
            state.AnzItemPersistenceContext.Verify(p => p.Update(It.Is<AnzItem>(i => i.IsDeleted == true)), Times.Once);
        }
