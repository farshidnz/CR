...
namespace CashrewardsOffers.Application.ANZ.Services
{
    ...
    public class InStoreMerchantRanking : Ranking
    {
        ...
        override public bool Filter(AnzItem anzItem) => anzItem.Offer?.Id == 0 && anzItem.Merchant.IsInstore;
    }
    ...
    public class PopularMerchantRanking : Ranking
    {
        ...
        override public bool Filter(AnzItem anzItem) => anzItem.Offer?.Id == 0 && anzItem.Merchant.IsPopular;
    }
}
