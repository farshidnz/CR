...
namespace CashrewardsOffers.Domain.Entities
{
    ...
    public class AnzItem
    {
        ...
        public bool IsUnavailable =>
            ...
            || (!Merchant.IsPopular && !Merchant.IsInstore && !Offer.IsFeatured);
    ...
    public class AnzMerchant
    {
        ...
        public bool IsPopular => PopularMerchantRankingForBrowser != 0;
        public int PopularRanking { get; set; }
        public bool IsInstore => NetworkId == TrackingNetwork.Instore;
